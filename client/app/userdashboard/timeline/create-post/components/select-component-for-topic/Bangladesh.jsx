import { bangladeshBishay, scrollToTop } from '@/app/assistantdashboard/components/data';
import React from 'react'

const Bangladesh = ({ stage, setStage, chapter, setChapter }) => {
    return (
        <div>
