  ...
  return (
    <div>
      ...
      <div
        ...
        } fixed duration-200 -left-0 md:left-1/3 md:h-auto pb-4 bg-white origin-bottom-left bottom-0 md:bottom-10 w-screen md:w-[30vw] z-50 md:ml-6 border rounded-md`}
      >
       {
