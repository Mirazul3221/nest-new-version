...
const BannerSection = () => {
  return (
    <div className="md:px-20 px-4 mt-20 md:mt-0 h-[80vh] relative">
      ...
      <div className="w-[500px] h-[200px] absolute top-[50%] left-[50%] -translate-y-[50%] -translate-x-[50%] blur-[180px] bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500"></div>
